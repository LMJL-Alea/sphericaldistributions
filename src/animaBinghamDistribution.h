...
public:
  ...
  void SetConcentrationParameters(const ValueType &x) {
    m_ConcentrationParameters = x;
  }
...
private:
  ...
  double ComputeCumulativeIntegral(double theta_max, double phi_max,
                                   int n_theta = 16, int n_phi = 32) const;
};
