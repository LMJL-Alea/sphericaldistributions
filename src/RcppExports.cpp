...
// dwatson
arma::vec dwatson(const arma::mat& x, const arma::rowvec& mu, double kappa, bool log);
...
RcppExport SEXP _sphericaldistributions_qwatson(SEXP pSEXP, SEXP muSEXP, SEXP kappaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const arma::rowvec& >::type mu(muSEXP);
    Rcpp::traits::input_parameter< double >::type kappa(kappaSEXP);
    rcpp_result_gen = Rcpp::wrap(qwatson(p, mu, kappa));
    return rcpp_result_gen;
END_RCPP
}
// rwatson
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sphericaldistributions_qwatson", (DL_FUNC) &_sphericaldistributions_qwatson, 3},
